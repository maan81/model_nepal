    ...
    public function new_subject($data = false){
		...
		if($this->input->post()){
			$data = array(
							...
							'email' 		=> $this->input->post('height'),
							'height' 		=> $this->input->post('weight'),
							'weight' 		=> $this->input->post('bust'),
							'bust' 			=> $this->input->post('waist'),
							'waist' 		=> $this->input->post('hip'),
							'hip' 			=> $this->input->post('shoe'),
							'shoe' 			=> $this->input->post('dress'),
							'dress' 		=> $this->input->post('hair_color'),
							'hair_color'	=> $this->input->post('hair_length'),
							'hair_length'	=> $this->input->post('skin'),
							'skin' 			=> $this->input->post('eyes'),
							'eyes' 			=> $this->input->post('teeth'),
							'teeth' 		=> $this->input->post('professional'),
							'professional'	=> $this->input->post('additional'),
							'additional'	=> $this->input->post('travelling_area'),
							'travelling_area'=>$this->input->post('travelling_duration'), 
