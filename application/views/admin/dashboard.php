...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
	<head>
		...
		<script src="<?php echo base_url().ADMINJS?>glow/1.7.0/core/core.js" type="text/javascript"></script>
		<script src="<?php echo base_url().ADMINJS?>glow/1.7.0/widgets/widgets.js" type="text/javascript"></script>
		<link href="<?php echo base_url().ADMINJS?>glow/1.7.0/widgets/widgets.css" type="text/css" rel="stylesheet" />
