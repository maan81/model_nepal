...
function validate_book(){
	var ok = true;
	if(!validateName($('#element_2').val())){
		$('#element_2').css('color','red');
		ok=false;
	}

	if(!validateEmail($('#element_3').val())){
		$('#element_3').css('color','red');
		ok=false;
	}
	/*
	if($isValidPhonenumber($('#element_4').val())){
		$('$element_4').css('color','red');
		ok=false;
	}
	*/
